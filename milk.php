                        ...
                        if($result->rowCount() > 0){
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = $result->fetch()){
                                 ...
                                 echo "<td>";
                                            echo '<a href="Rmilk.php?id='. $row['id'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"><i class="align-middle" data-feather="eye"></i></span></a>';
                                            echo '<a href="Umilk.php?id='. $row['id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"><i class="align-middle" data-feather="edit"></i></span></a>';
                                            echo '<a href="Dmilk.php?id='. $row['id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"><i class="align-middle" data-feather="delete"></i></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
