...
$id = $ccow = $icow = $cname = $gender = $breed = $ctype = $damn = $sire = $lactation = $dob = $cstatus = "";

$id_err = $ccow_err = $icow_err = $cname_err = $gender_err = $breed_err = $ctype_err = $damn_err = $sire_err = $lactation_err = $dob_err = $cstatus_err = ""; 
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_cname)){
     ...
     if(empty($input_gender)){
         $gender_err = "Please enter cow gender.";     
     } else{
         $gender = $input_gender;
     }
    ...
    if(empty($input_breed)){
        $breed_err = "Please enter cow breed.";     
    } else{
        $breed = $input_breed;
    }
    ...
    && empty($cstatus_err)){
        ...
        $sql = "INSERT INTO dkcows (ccow, icow, cname, gender, breed, ctype, damn, sire, lactation, dob, cstatus)
         VALUES (:ccow, :icow, :cname, :gender, :breed, :ctype, :damn, :sire, :lactation, :dob, :cstatus)";
    ...
    <!-- START MAIN -->
      ...
      <!-- END TOP NAV BAR -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Create Cow Record</h2>
                    <p>Please fill this form and submit to add cow record to the database.</p>
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="icow" class="form-control 
                            <?php echo (!empty($icow_err)) ? 'is-invalid' : ''; ?>"
                             value="<?php echo $icow; ?>">
                    ...
                    <div class="form-group">
                            ...
                            <?php echo (!empty($cname_err)) ? 'is-invalid' : ''; ?>"
                    ...
                    <div class="form-group">
                            ...
                            <?php echo (!empty($breed_err)) ? 'is-invalid' : ''; ?>"
                    ...
                    <div class="form-group">
                            ...
                            <?php echo (!empty($ctype_err)) ? 'is-invalid' : ''; ?>"
                             value="<?php echo $ctype; ?>">
                    ...
                    <!-- damn  -->
                        ...
                        <div class="form-group">
                            <label>Damn</label>
                            <input type="text" name="damn" class="form-control 
                            <?php echo (!empty($damn_err)) ? 'is-invalid' : ''; ?>" 
                            value="<?php echo $damn; ?>">
                    ...
                    <div class="form-group">
                            ...
                            <?php echo (!empty($sire_err)) ? 'is-invalid' : ''; ?>" 
                            value="<?php echo $sire; ?>">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="lactation" class="form-control 
                            <?php echo (!empty($lactation_err)) ? 'is-invalid' : ''; ?>" 
                            value="<?php echo $lactation; ?>">
                    ...
                    <div class="form-group">
                            ...
                            <?php echo (!empty($dob_err)) ? 'is-invalid' : ''; ?>" 
                            value="<?php echo $dob; ?>">
                    ...
                    <div class="form-group">
                            <label></label>Cow Status
                            <input type="text" name="cstatus" class="form-control 
                            <?php echo (!empty($cstatus_err)) ? 'is-invalid' : ''; ?>" 
