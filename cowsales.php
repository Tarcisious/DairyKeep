            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Cow Sales Records</h2>
                        <a href="Ccowsales.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Cow Sales</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    $sql = "SELECT * FROM dkcowsales";
                    if($result = $pdo->query($sql)){
                        if($result->rowCount() > 0){
                            echo '<table class="table table-bordered table-striped">';
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>Cow Sales ID</th>";
                                        echo "<th>Cow ID</th>";
                                        echo "<th>Invoice</th>";
                                        echo "<th>Price</th>";
                                ...
                                while($row = $result->fetch()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="Rcowsales.php?id='. $row['id'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span><i class="align-middle" data-feather="eye"></i></span></a>';
                                            echo '<a href="Ucowsales.php?id='. $row['id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span><i class="align-middle" data-feather="edit"></i></span></a>';
                                            echo '<a href="Dcowsales.php?id='. $row['id'] .'" title="Delete Record" data-toggle="tooltip"><span<i class="align-middle" data-feather="delete"></i></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
