    ...
    <!-- START MAIN -->
      ...
      <!-- END TOP NAV BAR -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="mt-5 mb-3">View  Cow Record</h1>
                    ...
                    <div class="form-group">
                        ...
                        <p><b><?php echo $row["ctype"]; ?></b></p>
                    </div>

                    <div class="form-group">
                    <label>Damn</label>
                        <p><b><?php echo $row["damn"]; ?></b></p>
                    </div>

                    <div class="form-group">
                        <label>Sire</label>
                        <p><b><?php echo $row["sire"]; ?></b></p>
                    </div>

                    <div class="form-group">
                        <label>Lactation Period</label>
                        <p><b><?php echo $row["lactation"]; ?></b></p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p><b><?php echo $row["cstatus"]; ?></b></p>
                    </div>


                    <p><a href="cows.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>        
        </div>
    </div>
