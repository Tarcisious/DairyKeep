            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Milk Sales Records</h2>
                        <a href="Cmilksales.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Milk Sales</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    $sql = "SELECT * FROM dkmilksales";
                    if($result = $pdo->query($sql)){
                        if($result->rowCount() > 0){
                            echo '<table class="table table-bordered table-striped">';
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>Milk Sales ID</th>";
                                        echo "<th>Milk code</th>";
                                        echo "<th>Customer</th>";
                                        echo "<th>Litres</th>";
                                        echo "<th>Price per Litre</th>";
                                        echo "<th>Date</th>";
                                        echo "<th>Total</th>";
                                        echo "<th>Action</th>";
                                    echo "</tr>";
                                ...
                                while($row = $result->fetch()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['plitre'] . "</td>";
                                        echo "<td>" . $row['date'] . "</td>";
                                        echo "<td>" . $row['total'] . "</td>";
                                       
                                 echo "<td>";
                                            echo '<a href="Rmilksales.php?id='. $row['id'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo '<a href="Umilksales.php?id='. $row['id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo '<a href="Dmilksales.php?id='. $row['id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
